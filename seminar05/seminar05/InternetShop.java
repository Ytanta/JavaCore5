...
final class InternetShop {
    ...
    void writeData(Object object) {
        ...
        if (object instanceof Product) {
            unloadDate(productsF, DataStorage.products, object);

        }
        if (object instanceof Customer) {
            unloadDate(customerF, DataStorage.customers, object);
        }
        if (object instanceof Order) {
            unloadDate(ordersF, DataStorage.orders, object);
        }
...
//                String nar = object.toString();
//                String[]nar1 = nar.split(",");
